import { CodeCommonAuthBackEnd, CodeCommonAuthEntry } from '../common/auth.common'
//essas mensagem sao vinda do "backend"
export const authMessagesBackEnd = {
  // Sucesso
    [CodeCommonAuthBackEnd.CONTA_ENCONTRADA]: 'Conta encontrada.',
    [CodeCommonAuthBackEnd.CONTA_REGISTRADA]: 'Conta registrada com sucesso.',
    [CodeCommonAuthBackEnd.CONTA_AUTENTICADA_LOGIN]: 'Login realizado com sucesso.',
    // Erros
    [CodeCommonAuthBackEnd.ERROR_EMAIL_EM_USO]: 'Este email já está em uso.',
    [CodeCommonAuthBackEnd.ERROR_USER_NOFIND]: 'Email ou senha inválidos.',
    [CodeCommonAuthBackEnd.ERROR_NOME_EM_USO]: 'Este nome já está em uso.',
    [CodeCommonAuthBackEnd.ERROR_INTERNO_SISTEMA]: 'Erro interno do sistema. Tente novamente.',
}
